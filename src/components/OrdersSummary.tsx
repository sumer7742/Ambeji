...
const OrdersSummary: React.FC = () => {
  ...
  if (isLoading)
    return (
      <div className="flex justify-center items-center min-h-screen text-[#dd3333]">
      ...
      <div className="max-w-7xl mx-auto p-4 md:p-6">
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <aside className="w-full md:w-64">
            <div className="sticky top-20 bg-white p-4 rounded-xl shadow-md border border-red-100">
              <h3 className="font-semibold mb-3 text-gray-700">Filters</h3>

              <p className="font-medium mb-2 text-gray-800">ORDER STATUS</p>
              {["Delivered", "Pending", "Cancelled"].map((status) => (
                <label
                  key={status}
                  className="block cursor-pointer text-gray-700 hover:text-[#dd3333]"
                >
                  <input
                    type="checkbox"
                    className="mr-2 accent-[#dd3333]"
          ...
          <main className="flex-1">
            ...
            <div className="mb-4">
              <input
                ...
                className="w-full px-4 py-2 border border-red-200 rounded-lg focus:ring-2 focus:ring-[#dd3333] focus:outline-none"
              />
            </div>
              ...
              {filteredOrders.length === 0 ? (
                ...
                filteredOrders.map((order: any) => {
                  ...
                  return (
                    <div
                      key={order._id}
                      className="bg-white p-4 rounded-xl shadow-sm hover:shadow-lg border border-red-100 hover:border-[#dd3333] transition-all"
                    >
                      <div className="flex justify-between items-center">
                        <div className="flex gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-500">
                              Transaction:{" "}
                              <span className="text-[#dd3333] font-mono">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          {viewDetailsHref && (
                            <Link
                              to={viewDetailsHref}
                              className="px-4 py-2 text-sm bg-[#dd3333] text-white rounded-lg hover:bg-[#b82a2a]"
                            >
                              View Details
                            </Link>
                          )}
